  ...
  return (
    <div className="flex flex-col lg:flex-row h-[80vh] p-4 m-4 lg:m-10 lg:ms-28 lg:me-28">
      ...
      <div className="bg-gray-900 h-full w-full lg:w-1/2 rounded-l-3xl flex flex-col justify-center p-4">
        <h1 className="text-center text-2xl font-semibold font-mono text-white mb-4">Sign In</h1>
        <div >
          ...
          {/* error showing */}
          <p className="text-red-500  font-mono text-center mt-2">{ error ? error ||  'something went wrong !!!' : ''}</p>
        </div>
      </div>
